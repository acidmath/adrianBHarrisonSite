...
export const handler = init(
	(() => {
		...
		return {
			...
			_: {
				client: {
					start: '_app/immutable/entry/start.BGdaovie.js',
					app: '_app/immutable/entry/app.SF_urcG5.js',
					imports: [
						'_app/immutable/entry/start.BGdaovie.js',
						'_app/immutable/chunks/entry.D1IdaYmH.js',
						'_app/immutable/chunks/runtime.G6EyfWjc.js',
						'_app/immutable/entry/app.SF_urcG5.js',
						'_app/immutable/chunks/runtime.G6EyfWjc.js',
